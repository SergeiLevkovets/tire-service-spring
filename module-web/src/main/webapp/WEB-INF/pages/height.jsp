                ...
                <div class="content-box-large box-with-header row">
                    <div class="row">
                        ...
                        <table class="table table-bordered">
                            ...
                            <c:forEach items="${elemList}" var="elem">
                                <tr>
                                    ...
                                    <td>
                                        <c:url value="/authorized/admin/height" var="update">
                                        ...
                                        <c:url value="/authorized/admin/height" var="delete">
                        ...
                        <form class="form-horizontal panel-body" id="elemChangeForm"
                              action="${pageContext.request.contextPath}/authorized/admin/height"
                              method="post">
