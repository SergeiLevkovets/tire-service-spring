            ...
            <div class="col-md-12 content-box-large">
                ...
                <div class="content-box-large box-with-header row">
                    ...
                    <div class="row">
                        ...
                        <table class="table table-bordered">
                            ...
                            <c:forEach items="${elemList}" var="elem">
                                <tr>
                                    ...
                                    <td>${elem[secondFieldArticle]}</td>
                                    <td>
                                        <c:url value="/authorized/admin/service-item" var="update">
                                        ...
                                        <c:url value="/authorized/admin/service-item" var="delete">
                        ...
                        <form class="form-horizontal panel-body" id="serviceItemForm"
                              action="${pageContext.request.contextPath}/authorized/admin/service-item"
                              method="post">
