            ...
            <div class="col-md-12 content-box-large">
                ...
                <div class="content-box-large box-with-header row">
                    <form class="form-horizontal panel-body" id="OrderStatistic_form"
                          action="${pageContext.request.contextPath}/authorized/admin/order-statistics"
                          method="get">
                        <div class="form-group row">
                            <div class="col-md-3">
                                <label>Сотрудник</label>
                                <select class="form-control" name="user" id="user" >
                                    <option value="allUsers">Все сотрудники</option>
                                    <c:forEach items="${usersList}" var="userDTO">
